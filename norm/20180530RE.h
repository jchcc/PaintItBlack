...
#define RENDERER_PTR	*reinterpret_cast<DWORD*>(0x00E65EE8)
...
#define GETTALKTYPE_FN				0x008050C0
#define RECALCAVERAGEPINGTIME_FN	0x00817790
#define SESSION_PTR					0x00FC9BA0

//
// CUIWindowMgr defines
//
#define UIWINDOWMGR_MAKEWINDOW_FN 0x005CB700
#define UIWINDOWMGR_PTR 0x00E68CE8
...
// sub types
// CUIBookWnd
#define UIBOOKWND_SENDMSG_FN 0x00504B20
