...
#define DRAWSCENE_FN 0x0047FF80
#define RENDERER_PTR *reinterpret_cast<DWORD*>(0x00C054F8)
//
// CSession defines
//
...
#define SESSION_DATA                      	\
    ...
    /* +0x1484 */ ULONG aid;               	\
    /* +0x1488 */ ULONG gid;               	\
    /* +0x148C */ BYTE offset4[0x8];       	\
    /* +0x1494 */ int job;                 	\
    /* +0x1498 */ int exp;                 	\
	/* +0x149C */ BYTE offset6[0x4];       	\
    /* +0x14A0 */ int next_exp;            	\
	/* +0x14A4 */ BYTE offset7[0x4];		\
	/* +0x14A8 */ int jobnextexp;			\
	/* +0x14AC */ BYTE offset8[0x4];		\
	/* +0x14B0 */ int jobexp;				\
	/* +0x14B4 */ BYTE offset9[0x4];		\
	/* +0x14B8 */ int level;				\
	/* +0x14BC */ BYTE offset10[0x4];		\
    /* +0x14C0 */ int joblevel;            	\
    /* +0x14C4 */ int skillPoints;			\
    /* +0x14C8 */ BYTE offset11[0x6168];   \
    /* +0x7630 */ char c_name[40];
//};

#define GETTALKTYPE_FN				0x00986950
#define RECALCAVERAGEPINGTIME_FN	0x009997D0
#define SESSION_PTR					0x00E75598

//
// CUIWindowMgr defines
//
#define UIWINDOWMGR_MAKEWINDOW_FN 0x006EA300
#define UIWINDOWMGR_PTR 0x00CD1C20
...
// sub types
// CUIBookWnd
#define UIBOOKWND_SENDMSG_FN 0x0060EB10
